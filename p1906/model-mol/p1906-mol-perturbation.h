...
#ifndef P1906_MOL_PERTURBATION
#define P1906_MOL_PERTURBATION
 ...
 *
 * \class P1906MOLPerturbation
 *
 * \brief Base class implementing the Perturbation component of
 * the P1906 framework
 */

class P1906MOLPerturbation : public P1906Perturbation
{
public:
  static TypeId GetTypeId (void);

  P1906MOLPerturbation ();
  virtual ~P1906MOLPerturbation ();
