...
#ifndef P1906_MOL_MESSAGE_CARRIER
#define P1906_MOL_MESSAGE_CARRIER
...
class P1906MOLMessageCarrier : public P1906MessageCarrier
{
public:
  static TypeId GetTypeId (void);

  P1906MOLMessageCarrier ();
  virtual ~P1906MOLMessageCarrier ();
...
#endif /* P1906_MOL_MESSAGE_CARRIER */
