...
NS_LOG_COMPONENT_DEFINE ("P1906MOLTransmitterCommunicationInterface");

TypeId P1906MOLTransmitterCommunicationInterface::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOLTransmitterCommunicationInterface")
    .SetParent<P1906TransmitterCommunicationInterface> ();
  return tid;
}

P1906MOLTransmitterCommunicationInterface::P1906MOLTransmitterCommunicationInterface ()
{
